return {
	{
		...
		config = function()
			...
			keymap.set("n", "<leader>gC", builtin.git_bcommits, { desc = "[G]it [B]uffer commits" })
			keymap.set("n", "<leader>gb", builtin.git_branches, { desc = "[G]it [B]ranch" })
			keymap.set("n", "<leader>cs", builtin.colorscheme, { desc = "[C]hange Color [S]cheme" })
